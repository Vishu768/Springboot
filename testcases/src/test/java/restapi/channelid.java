...
public class channelid {
	...
	@Test
		...
		public void check() {
			...
			//LoginrequestData.setChannelIdentifier();
	...
	public void check1() {
		...
		RequestDataForm LoginrequestData=new RequestDataForm();
		LoginrequestData.setInstitutionId(1001);
		LoginrequestData.setChannelIdentifier("IBI");
		LoginrequestData.setRequestType("LA");
		LoginrequestData.setUserCategory(1);
		LoginrequestData.setBranchCode("10001");
		LoginrequestData.setUserId("4100141");
		...
		logincheck1.setRequestResultantValue("502A681A888C65426DEC0357947E5D617890ABBC87E4249957495D1CC7BAD36D");
	...
	public void check2() {
		...
		RequestDataForm LoginrequestData=new RequestDataForm();
		LoginrequestData.setInstitutionId(1001);
		LoginrequestData.setChannelIdentifier("44117");
		LoginrequestData.setRequestType("LA");
		LoginrequestData.setUserCategory(1);
		LoginrequestData.setBranchCode("10001");
		LoginrequestData.setUserId("4100141");
		...
		logincheck2.setRequestResultantValue("1F7DD7A774EC878F5F9E5AEDCF3E1B09E0567C81B9FDB21EDB1944424B9F831B");
