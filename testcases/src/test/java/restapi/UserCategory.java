...
public class UserCategory {
	...
	@Test
		...
		public void check() {
			...
			String req="[instituitionID=1001, channelIdentifier=IB, requestType=LA, branchCode=10001, userCategory=null, userId=4100141, serviceKey=NA, requestDate=29/07/2021, requestTime=16:30:22.328, requestReferenceNo=LA290721163022328338], requestResultantValue=EEBA265BB2BD5F41A49A2B7D35970E962E3CB608190F523FD80372235FC4CAAA]";
			...
			//LoginrequestData.setUserCategory();
			...
			logincheck.setRequestResultantValue("EEBA265BB2BD5F41A49A2B7D35970E962E3CB608190F523FD80372235FC4CAAA");
	...
	public void check1() {
		...
		String req="{\"institutionId\":1001,\"channelIdentifier\":\"IB\",\"requestType\":\"LAS\",\"branchCode\":\"10001\",\"userCategory\":1,\"userId\":\"4100141\",\"serviceKey\":\"NA\",\"requestDate\":\"29/07/2021\",\"requestTime\":\"16:30:22.328\",\"requestReferenceNo\":\"LA290721163022328338\"}";
		RequestDataForm LoginrequestData=new RequestDataForm();
		LoginrequestData.setInstitutionId(1001);
		LoginrequestData.setChannelIdentifier("IB");
		LoginrequestData.setRequestType("LA");
		LoginrequestData.setUserCategory(123);
		LoginrequestData.setBranchCode("10001");
		LoginrequestData.setUserId("4100141");
		...
		logincheck1.setRequestResultantValue("0566B940FA47D8337D0C544754273C46BBE100EAF86416D77EAFBC98E8443688");
	...
	public void check2() {
		...
		String req="{\"institutionId\":1001,\"channelIdentifier\":\"IB\",\"requestType\":\"SS\",\"branchCode\":\"10001\",\"userCategory\":1,\"userId\":\"4100141\",\"serviceKey\":\"NA\",\"requestDate\":\"29/07/2021\",\"requestTime\":\"16:30:22.328\",\"requestReferenceNo\":\"LA290721163022328338\"}";
		RequestDataForm LoginrequestData=new RequestDataForm();
		LoginrequestData.setInstitutionId(1001);
		LoginrequestData.setChannelIdentifier("IB");
		LoginrequestData.setRequestType("LA");
		LoginrequestData.setUserCategory(111);
		LoginrequestData.setBranchCode("10001");
		LoginrequestData.setUserId("4100141");
		...
		logincheck2.setRequestResultantValue("A547FB2DF63E2AA40D02F4F2E205878EF2ECFDA88E28BC2E90A56F261D2C9A43");
