...
public class UserCategory {
	...
	public void userCategorynull() {
		...
		LoginRequest loginuserCategorynull = getLoginAPIReq_userCategoryNull();

		System.out.println(loginuserCategorynull);

		request.body(loginuserCategorynull);
		...
		Assert.assertEquals(loginResponse.getResponseData().getRequestReferenceNo(),
				loginuserCategorynull.getRequestData().getRequestReferenceNo());
		Assert.assertTrue(responseReferenceNoValidation);
	}

	@Test

	public void userCategorylength() {
		...
		LoginRequest loginuserCategorylength = getLoginAPIReq_userCategoryLength();

		System.out.println(loginuserCategorylength);

		request.body(loginuserCategorylength);
		Response response = request.post("https://products.fss.co.in/CMSAPI/login");
		System.out.println(response.asString());
		int code = response.getStatusCode();
		Assert.assertEquals(code, 200);
		...
		Assert.assertEquals("", loginResponse.getResponseData().getAuthValue());
		Assert.assertEquals(loginResponse.getResponseData().getRequestReferenceNo(),
				loginuserCategorylength.getRequestData().getRequestReferenceNo());
		Assert.assertTrue(responseReferenceNoValidation);
	}

	@Test
	public void userCategorydatabase() {
		...
		LoginRequest loginuserCategorydatabase = getLoginAPIReq_userCategorydatabase();

		System.out.println(loginuserCategorydatabase);

		request.body(loginuserCategorydatabase);
		Response response = request.post("https://products.fss.co.in/CMSAPI/login");
		System.out.println(response.asString());
		int code = response.getStatusCode();
		Assert.assertEquals(code, 200);
		...
		Assert.assertEquals("", loginResponse.getResponseData().getAuthValue());
		Assert.assertEquals(loginResponse.getResponseData().getRequestReferenceNo(),
				loginuserCategorydatabase.getRequestData().getRequestReferenceNo());
		Assert.assertTrue(responseReferenceNoValidation);
	}
	...
	static RequestDataForm getRequestData_userCategoryNull(String reqType) {
	...
	static LoginRequest getLoginAPIReq_userCategoryNull() {
		LoginRequest loginReq = new LoginRequest();

		loginReq.setRequestData(getRequestData_userCategoryNull("LA"));
	...
	static RequestDataForm getRequestData_userCategorylength(String reqType) {
		RequestDataForm reqData = new RequestDataForm();
		reqData.setBranchCode("20002");
		reqData.setRequestType(reqType);
		reqData.setRequestDate(getDate());
		...
		reqData.setInstitutionId(1000);
		reqData.setChannelIdentifier("IB");
		reqData.setUserCategory(100);
		reqData.setUserId("41000182");
		reqData.setServiceKey("NA");
		return reqData;
	}

	static LoginRequest getLoginAPIReq_userCategoryLength() {
		LoginRequest loginReq = new LoginRequest();

		loginReq.setRequestData(getRequestData_userCategorylength("LA"));
	...
	static RequestDataForm getRequestData_userCategorydatabase(String reqType) {
		RequestDataForm reqData = new RequestDataForm();
		reqData.setBranchCode("20002");
		reqData.setRequestType(reqType);
		reqData.setRequestDate(getDate());
		...
		reqData.setInstitutionId(1000);
		reqData.setChannelIdentifier("IB");
		reqData.setUserCategory(0);
		reqData.setUserId("41000182");
		reqData.setServiceKey("NA");
		return reqData;
	}

	static LoginRequest getLoginAPIReq_userCategorydatabase() {
		LoginRequest loginReq = new LoginRequest();

		loginReq.setRequestData(getRequestData_userCategorydatabase("LA"));
