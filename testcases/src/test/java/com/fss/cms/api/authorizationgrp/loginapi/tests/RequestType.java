...
public class RequestType {
	...
	public void requestTypenull() {
		...
		LoginRequest loginrequestTypenull = getLoginAPIReq_requestTypeNull();

		System.out.println(loginrequestTypenull);

		request.body(loginrequestTypenull);
		...
		Assert.assertEquals(loginResponse.getResponseData().getRequestReferenceNo(),
				loginrequestTypenull.getRequestData().getRequestReferenceNo());
	...
	public void requestTypelength() {
		...
		LoginRequest loginrequestTypelength = getLoginAPIReq_requestTypeLength();

		System.out.println(loginrequestTypelength);

		request.body(loginrequestTypelength);
		Response response = request.post("https://products.fss.co.in/CMSAPI/login");
		System.out.println(response.asString());
		int code = response.getStatusCode();
		Assert.assertEquals(code, 200);
		...
		Assert.assertEquals("", loginResponse.getResponseData().getAuthValue());
		Assert.assertEquals(loginResponse.getResponseData().getRequestReferenceNo(),
				loginrequestTypelength.getRequestData().getRequestReferenceNo());
		Assert.assertTrue(responseReferenceNoValidation);

	}

	@Test
	public void requestTypedatabase() {
		...
		LoginRequest loginrequestTypedatabase = getLoginAPIReq_requestTypedatabase();

		System.out.println(loginrequestTypedatabase);

		request.body(loginrequestTypedatabase);
		Response response = request.post("https://products.fss.co.in/CMSAPI/login");
		System.out.println(response.asString());
		int code = response.getStatusCode();
		Assert.assertEquals(code, 200);
		...
		Assert.assertEquals("", loginResponse.getResponseData().getAuthValue());
		Assert.assertEquals(loginResponse.getResponseData().getRequestReferenceNo(),
				loginrequestTypedatabase.getRequestData().getRequestReferenceNo());
		Assert.assertTrue(responseReferenceNoValidation);
	...
	static RequestDataForm getRequestData_requestTypeNull(String reqType) {
	...
	static LoginRequest getLoginAPIReq_requestTypeNull() {
		LoginRequest loginReq = new LoginRequest();

		loginReq.setRequestData(getRequestData_requestTypeNull("LA"));
	...
	static RequestDataForm getRequestData_requestTypelength(String reqType) {
		RequestDataForm reqData = new RequestDataForm();
		reqData.setBranchCode("20002");
		reqData.setRequestType("AAAA");
		reqData.setRequestDate(getDate());
		reqData.setRequestTime(getTime());
		reqData.setRequestReferenceNo(getRefNo(reqType, reqData.getRequestDate(), reqData.getRequestTime()));//
		reqData.setInstitutionId(1000);
	...
	static LoginRequest getLoginAPIReq_requestTypeLength() {
		LoginRequest loginReq = new LoginRequest();

		loginReq.setRequestData(getRequestData_requestTypelength("LA"));
	...
	static RequestDataForm getRequestData_requestTypedatabase(String reqType) {
		RequestDataForm reqData = new RequestDataForm();
		reqData.setBranchCode("20002");
		reqData.setRequestType("AB");
		reqData.setRequestDate(getDate());
		reqData.setRequestTime(getTime());
		reqData.setRequestReferenceNo(getRefNo(reqType, reqData.getRequestDate(), reqData.getRequestTime()));//
		reqData.setInstitutionId(1000);
	...
	static LoginRequest getLoginAPIReq_requestTypedatabase() {
		LoginRequest loginReq = new LoginRequest();

		loginReq.setRequestData(getRequestData_requestTypedatabase("LA"));
