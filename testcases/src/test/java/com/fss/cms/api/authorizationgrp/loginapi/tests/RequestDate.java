...
public class RequestDate {
	...
	public void requestDatenull() {
		...
		LoginRequest loginrequestDatenull = getLoginAPIReq_requestDateNull();

		System.out.println(loginrequestDatenull);

		request.body(loginrequestDatenull);
		...
		Assert.assertEquals(loginResponse.getResponseData().getRequestReferenceNo(),
				loginrequestDatenull.getRequestData().getRequestReferenceNo());
	...
	public void requestDatelength() {
		...
		LoginRequest loginrequestDatelength = getLoginAPIReq_requestDateLength();

		System.out.println(loginrequestDatelength);

		request.body(loginrequestDatelength);
		Response response = request.post("https://products.fss.co.in/CMSAPI/login");
		System.out.println(response.asString());
		int code = response.getStatusCode();
		Assert.assertEquals(code, 200);
		...
		Assert.assertEquals("", loginResponse.getResponseData().getAuthValue());
		Assert.assertEquals(loginResponse.getResponseData().getRequestReferenceNo(),
				loginrequestDatelength.getRequestData().getRequestReferenceNo());
		Assert.assertTrue(responseReferenceNoValidation);
	}

	@Test
	public void requestDateinvalid() {
		...
		LoginRequest loginrequestDateinvalid = getLoginAPIReq_requestDateinvalid();

		System.out.println(loginrequestDateinvalid);

		request.body(loginrequestDateinvalid);
		Response response = request.post("https://products.fss.co.in/CMSAPI/login");
		System.out.println(response.asString());
		int code = response.getStatusCode();
		Assert.assertEquals(code, 200);
		...
		Assert.assertEquals("", loginResponse.getResponseData().getAuthValue());
		Assert.assertEquals(loginResponse.getResponseData().getRequestReferenceNo(),
				loginrequestDateinvalid.getRequestData().getRequestReferenceNo());
		Assert.assertTrue(responseReferenceNoValidation);
	...
	static RequestDataForm getRequestData_requestDateNull(String reqType) {
		...
		reqData.setRequestReferenceNo(getRefNo(reqType, getDate(), reqData.getRequestTime()));//
	...
	static LoginRequest getLoginAPIReq_requestDateNull() {
		LoginRequest loginReq = new LoginRequest();

		loginReq.setRequestData(getRequestData_requestDateNull("LA"));
	...
	static RequestDataForm getRequestData_requestDateLength(String reqType) {
		RequestDataForm reqData = new RequestDataForm();
		reqData.setBranchCode("20002");
		reqData.setRequestType(reqType);
		reqData.setRequestDate("351/072/21254112");
		reqData.setRequestTime(getTime());
	...
	static LoginRequest getLoginAPIReq_requestDateLength() {
		LoginRequest loginReq = new LoginRequest();

		loginReq.setRequestData(getRequestData_requestDateLength("LA"));
	...
	static RequestDataForm getRequestData_requestDateinvalid(String reqType) {
		RequestDataForm reqData = new RequestDataForm();
		reqData.setBranchCode("20002");
		reqData.setRequestType(reqType);
		reqData.setRequestDate("11/25/4111");
		reqData.setRequestTime(getTime());
		reqData.setRequestReferenceNo(getRefNo(reqType, reqData.getRequestDate(), reqData.getRequestTime()));//
		reqData.setInstitutionId(1000);
		reqData.setChannelIdentifier("IB");
	...
	static LoginRequest getLoginAPIReq_requestDateinvalid() {
		LoginRequest loginReq = new LoginRequest();

		loginReq.setRequestData(getRequestData_requestDateinvalid("LA"));
